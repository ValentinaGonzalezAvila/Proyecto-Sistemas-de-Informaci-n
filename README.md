...
* Podemos evidenciar que a lo largo de los años han venido aumentando la cantidad de procesos, pues en el 2012 hubo 31mil, estos vinieron aumentando gradualmente, pero luego en el año 2016 se dispararon a 46mil procesos, este valor se mantuvo hasta el 2018, para luego bajar a 40mil casos en el 2019, se mantuvo igual por el 2020, Pero luego en el año 2021 se dispararon hasta los 55 mil procesos. Esto para un total de 409.617 mil casos en 9 años.<br>
                                                                                                                                                                       Una vez realizado todo el análisis de los datos obtenidos nos hemos dado cuenta de que existe una gran escasez de datos y falta de accesibilidad, pues muchas veces no se diligencian por completo los datos, lo que impide un adecuado manejo de los datos.<br>
                                                                                                                                                                       ### 7. Conclusiones
